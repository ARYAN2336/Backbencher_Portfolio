...
const info = [
  {
    ...
    description: "(+91) 7016655338",  
    action: () => (window.location.href = "tel:+917016655338"),
  },
  {
    icon: <FaEnvelope />,
    title: "Email",
    description: "aryanmunjpara17@gmail.com",
    action: () => (window.location.href = "mailto:aryanmunjpara17@gmail.com"),
  },
  {
    icon: <FaMapMarkerAlt />,
    title: "Location",
    description: "Ahamdabad, Gujarat",
    action: () =>
      window.open("https://www.google.com/maps?q=Ahamdabad+Gujarat", "_blank"),
  },
];
...
const Contact = () => {
  ...
  async function handleSubmit(event) {
    ...
    formData.append("access_key", "37e54d19-e2a5-40d4-85da-feab6a68bd47");
